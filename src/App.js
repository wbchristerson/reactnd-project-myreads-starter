        ...
        <div className="bookshelf-books">
          <ol className="books-grid">
            {this.props.books.map((book) => (
              <Book key={book.title} bookTitle={book.title} bookAuthor={book.author} coverURL={book.url}/>
            ))}
          </ol>
        </div>
      </div>
        ...
        {this.state.showSearchPage ? (
          ...
          <div className="list-books">
            ...
            <div className="list-books-content">
              <div>
                <Shelf shelfTitle="Currently Reading" books={this.state.currentlyReading}/>
                <Shelf shelfTitle="Want to Read" books={this.state.wantToRead}/>
                <Shelf shelfTitle="Read" books={this.state.read}/>
              </div>
            </div>
